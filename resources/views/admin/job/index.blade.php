                ...
                <div class="section-item-right mb-5">
                    <form id="formSearch" class="border-0" method="GET" action="{{ route('job.suggest') }}">
                        <div class="form-group ">
                            <select class="js-example-basic-single form-control"  id="first_suggest" data-type="company" data-placeholder="Select company name"  name="state">
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group" style="width: 100px">
                            <select class="js-example-basic-single form-control" id="select_active" data-type="active" data-placeholder="Status" name="state">
                            </select>
                        </div>
                        <a href="{{route("job.index")}}"><button type="button" id="clearCategory" class="btn-add">CLEAR</button></a>
                    </form>
                </div>
            </section>
            <div id="append_ajax">
            <div class="table-main">
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td> {{ $value['title'] }} </td>
                        <td><input class="toggle_switch ms-3 mt-3 status_active" data-type="job with title " data-id="{{$value['job_id']}}" data-name="{{$value['title']}}" {{$value['active']==1?'checked':''}}  type="checkbox"></td>
                        <td>
...
<div class="d-none" id="csrf" data-csrf="{{ @csrf_token() }}"></div>
