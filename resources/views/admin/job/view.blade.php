                ...
                <form action="#" class="form-main p-3">
                    <div class="form_add_company flex-wrap mb-3">
                        ...
                        <div class="form-admin-insert-data mb-5">
                            ...
                            <textarea class="WYSIWYG" cols="40" rows="3" id="summernote" name="job_requirements" disabled
                        ...
                        <div class="d-flex form optional flex-wrap mb-5 me-5">
                            <div class="form-admin-insert-data w-50 me-0">
                                ...
                                <input type="text" name="first-name" class="ms-5 me-5" disabled value="{{$job->minimum_rate . ' - ' . $job->maximum_rate}}">
                            </div>

                            <div class="form-admin-insert-data w-50 me-0">
                                <label class="mt-2">Salary ($): </label>
                                <input type="text" name="first-name" class="" disabled value="{{$job->minimum_salary . ' - ' . $job->maximum_salary}}">
                            </div>
                        ...
                        <div class="form d-flex me-5">
                            <div class="form-admin-insert-data w-50 me-0">
                                ...
                                <input type="text" name="first-name" class="ms-5 me-5" disabled value="{{$job->closing_day}}">
                            </div>
                            <div class="w-25 m-auto d-flex">
                                <h5>Active Company</h5>
                                <span id="change_active" data-url="{{ route('job.update') }}"> </span>
                                <input class=" ms-3 mt-2 me-5 status_active" data-type="job with title " data-id="{{$job->job_id}}" data-name="{{$job->title}}" {{$job->active==1?'checked':''}}  type="checkbox">
                            </div>
                        </div>
                        ...
                        <div class=" text-end ">
                            <div class="text-end">
                                <div class="form ">
                                    <input type="submit" style="width:10rem;" value="SAVE"   class="btn me-3 text-light mt-3 rounded-pill fw-bold fs-6 mb-0 toggle_switch" data-type="view" data-id="{{$job->job_id}}" data-name="">
                                    <a href="{{ route('job.index') }}" class="text-decoration-none">
                                        <button type="button" style="width:10rem;padding: 0.75rem;" class="btn btn-danger mt-3 rounded-pill fw-bold fs-6 me-3">
                                            REFUSE
                                        </button>
                                    </a>
