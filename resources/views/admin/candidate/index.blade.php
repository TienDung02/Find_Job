            ...
            <div class="table-main">
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td><input class="toggle_switch ms-3 mt-3" data-type="candidate with name " data-id="{{$value['id_candidate']}}" data-name="{{$value['last_name'] . ' ' . $value['first_name']}}" {{$value['active']==1?'checked':''}}  type="checkbox"></td>
                        <td class="d-flex">
