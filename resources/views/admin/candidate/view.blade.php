                            ...
                            <div class="d-flex  pe-0 justify-content-between pb-5 form-admin-insert-data" style="">
                                ...
                                <div style="width: 65%" class="mt-5">
                                    <div class="form-admin-insert-data w-100">
                                        ...
                                        <input type="text" name="first-name" class="search-field" disabled value="{{$data->first_name}}">
                                    </div>
                                    <div class="form-admin-insert-data w-100">
                                        <label for="#">Last name</label>
                                        <input type="text" class="search-field" name="last-name" disabled value="{{$data->last_name}}">
                                    </div>
                                    <div class="form-admin-insert-data w-100">
                                        <label for="#">Telephone</label>
                                        <input type="text" name="tel" class="search-field" disabled value="{{$data->tel}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-admin-insert-data">
                                <label for="#">Email</label>
                                <input type="text" name="email" disabled value="{{$user->email ?? 'No email available'}}">
                            </div>
                ...
                <form action="#" class="form-main p-3">
                    <div class="form d-flex me-5">
                        <div class="w-25 m-auto d-flex">
                            ...
                            <input class=" ms-3 mt-2 me-5 status_active" data-type="job with title " data-id="{{$data->id_candidate}}" data-name="{{$data->last_name . ' ' . $data->first_name}}" {{$data->active==1?'checked':''}}  type="checkbox">
                        </div>
                    </div>
                    ...
                    <div class=" text-end ">
                        <div class="text-end">
                            <div class="form ">
                                <input type="submit" style="width:10rem;" value="SAVE"   class="btn me-3 text-light mt-3 rounded-pill fw-bold fs-6 mb-0 toggle_switch" data-type="view" data-id="{{$data->id_candidate}}" data-name="">
