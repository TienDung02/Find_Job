                ...
                <div class="section-item-right mb-5">
                    <form id="formSearch" class="border-0" method="GET" action="{{ route('company.suggest') }}">
                        <div class="form-group ">
                            <select class="js-example-basic-single form-control"  id="first_suggest" data-type="employer" data-placeholder="Employer"  name="state">
                            </select>
                        </div>
                        <div class="form-group">
                            <select class="js-example-basic-single form-control" id="second_suggest" data-type="company" data-placeholder="Company" name="state">
                            </select>
                        </div>
                        ...
                        <a href="{{route("company.index")}}"><button type="button" id="clearCategory" class="btn-add">CLEAR</button></a>
                    </form>
                </div>
            </section>
            <div id="append_ajax">
