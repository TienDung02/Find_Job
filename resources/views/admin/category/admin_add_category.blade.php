    ...
    <main>
        ...
        <div class="contain">
            ...
            <div class="parent-form-admin">
                <form action="{{ $category_id != '' ? route('categories.update', $category_id) : route('categories.store') }}" method="POST" class="form-main">
                    @csrf
                    @if($category_id != '')
                        @method('PUT')
                    @endif
                    <div class="form-admin-company flex-wrap" >
                        <div class="about-contact-person m-auto" style=" width: 1000px;">
                            ...
                            <div class="form-admin-insert-data">
                                ...
                                <input type="text" name="name" value="{{ $category_id != '' ? $name : '' }}" placeholder="Name">
                            </div>
