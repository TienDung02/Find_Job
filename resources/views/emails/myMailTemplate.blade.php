            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;" >
                ...
                <tr>
                    <td align="center"  bgcolor="#f0f0f0" class="container-padding">
                        ...
                        <!-- Content -->
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:80%;">
                            <tr>
                                <td height="50" style="font-size:50px;line-height:50px;" >&nbsp;</td>
                            </tr>
                            <tr  >
                                <td height="30" style="font-size:1.25rem;line-height:30px;" >Dear {{$name}}</td>
                            </tr>
                            <tr  >
                                <td height="30" style="font-size:1.25rem;line-height:30px;display: flex" >Your current password is: <p style="color: #2db2ea">&nbsp;{{$password}}</p></td>
                            </tr>
                            <tr  >
                                <td height="30" style="font-size:1.25rem;line-height:30px;" >Work Scout send you a token to activate your account.</td>
                            </tr>
                            <tr  >
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <div>
                                        <a style="cursor: pointer; padding: 1rem 2rem;border: none;background-color: #2db2ea;border-radius: 5px;color: #fff;" class="cursor-pointer" href="{{$url}}">Activate account</a>
                                    </div>
