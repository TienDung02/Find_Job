                        ...
                        <div class="messages-container margin-top-0 ">
                            ...
                            <div class="messages-container-inner d-flex  min-height-60vh max-height-60vh ">
                                <div class="messages-inbox">
                                    <ul class="">
                                        @if($chat_selected->user_1 == auth()->user()->id)
                                                        ...
                                                        <div class="d-flex short-messages w-100">
                                                            <p class="m-0 fw-semibold">
                                                                @if($chat_selected->last_messages_sender == Session::get('user_data.id'))
                                                                    You:
                                                                @else
                                                                    {{'@'.$chat_selected->user2->user_name}}
                                                                @endif
                                                                {{truncateText($chat_selected->last_messages, 30)}}</p>
                                                            <span class="Temporary position-absolute end-0 rounded-circle">2</span>
                                                        </div>
                                                    </div>
                                                </a>
                                            </li>
                                        @elseif($chat_selected->user_2 == auth()->user()->id)
                                            <li class="active-message">
                                                <a href="" class="d-flex row m-0">
                                                    <div class="message-avatar col-2 p-0">
                                                        <img class="rounded-circle"
...
{{--                                            <h5>{{$chat_list->last_messages_sender}}</h5>--}}
{{--                                            <h5>{{auth()->user()->id}}</h5>--}}

                                            @if($chat_list->user_1 == auth()->user()->id)
                                                <li>
                                                    <a href="" class="d-flex row m-0">
                                                        <div class="message-avatar col-2 p-0">
                                                            <img class="rounded-circle"
                                                            ...
                                                            <div class="d-flex short-messages w-100">
                                                                <p class="m-0 fw-semibold">
                                                                    @if($chat_list->last_messages_sender == Session::get('user_data.id'))
                                                                        You:
                                                                    @else
                                                                        {{$chat_list->user2->first_name}}:
                                                                    @endif
                                                                    {{truncateText($chat_list->last_messages, 30)}}</p>
                                                                <span class="Temporary position-absolute end-0 rounded-circle">2</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </li>
                                            @elseif($chat_list->user_2 == auth()->user()->id)
                                                <li>
                                                    <a href="" class="d-flex row m-0">
                                                        <div class="message-avatar col-2 p-0">
                                                            <img class="rounded-circle"
                                ...
                                <div class="message-content position-relative d-grid">
                                    <div class="overflow-y-auto message-content-block padding-50 pb-0">
