                    ...
                    <div class="col-lg-12 col-md-12" >
                        <div class="messages-container margin-top-0 ">
                            ...
                            <div class="messages-container-inner d-flex  min-height-60vh max-height-70vh ">
                                        ...
                                        <li class="active-message">
                                            <a href="" class="d-flex row m-0">
                                                <div class="message-avatar col-2 p-0">
                                                    <img class="rounded-circle" src="http://www.gravatar.com/avatar/00000000000000000000000000000000?d=mm&s=70" alt="">
                                                </div>
                                                <div class="message-by col-10 position-relative">
                                                    ...
                                                    <p class="m-0 fw-semibold">{{truncateText('Hello, I want to talk about your great listing!
                                                        ...
                                                        <span class="Temporary position-absolute end-0 rounded-circle">2</span>
                                                    </div>
                                                </div>
                                            </a>
                                        </li>
                                            ...
                                            <a href="" class="d-flex row m-0">
                                                ...
                                                <div class="message-by col-10 position-relative">
                                                    ...
                                                    <p class="m-0 fw-nomal">You: {{truncateText('Hello, I want to talk about your great listing!
                                                        Morbi velit eros, sagittis in facilisis non, rhoncus et erat.
                                                         Nam posuere tristique sem, eu ultricies', 30)}}</p>
                                                        <span class="bg-secondary position-absolute end-0 rounded-circle text-white"><i class="bi bi-check-lg"></i></span>
                                                    </div>
                                                </div>
                                            </a>
                                        </li>
                                            ...
                                            <a href="" class="d-flex row m-0">
                                                ...
                                                <div class="message-by col-10 position-relative">
                                                    ...
                                                    <p class="m-0 fw-normal">You: {{truncateText('Hello, I want to talk about your great listing!
                                                        Morbi velit eros, sagittis in facilisis non, rhoncus et erat.
                                                         Nam posuere tristique sem, eu ultricies', 30)}}</p>
                                                        <span class="Full-Time position-absolute end-0 rounded-circle text-white"><i class="bi bi-check-all"></i></span>
                                                    </div>
                                                </div>
                                            </a>
                                        </li>
                                ...
                                <div class="message-content pb-5 position-relative">
                                    <div class="max-height-85 message-content-block padding-50 pb-0">
                                    ...
                                    <div class="min-height-15 position-absolute border-top bottom-0 w-100 ps-5 pe-5 pt-0 ps-0">
                                                ...
                                                <div class="position-relative h-100">
                                                    ...
                                                    <div class="d-flex mt-3">
                                                        <div class="width-10 d-flex align-items-center">
                                                            <a class="text-secondary hover-button btn-select-img fs-2 w-50"><i class="bi bi-image"></i></a>
                                                            <a class="text-secondary ms-3 emoji hover-button col-1 fs-2 w-50"><i class="bi bi-emoji-smile"></i></a>
                                                        </div>
                                                        ...
                                                        <div class="icon-textarea width-5 d-flex align-items-center">
                                                            <a class="text-secondary me-5 hover-button">
                                                                <button style="height: 40px" class="d-flex align-items-center">
