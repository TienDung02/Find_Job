...
//        $resumes->full_name = $request->input('full_name');
//        $resumes->email = $request->input('email');
//        $resumes->professional_title = $request->input('professional_title');
//        $resumes->province_id = $request->input('province_id');
//        $resumes->district_id = $request->input('district_id');
//        $resumes->ward_id = $request->input('ward_id');
//
...
//            $resumes->photo = $url;
//        }else{
//            $resumes->photo = $request->input('avatar_old');
//        }
//
//        $type_salary = $request->input('type_salary');
//        if ($type_salary == 1){
//            $resumes->minimum_salary = $request->input('minimum_salary') ?? ' ';
//            $resumes->maximum_salary = $request->input('maximum_salary') ?? ' ';
//            $resumes->salary = null;
//        }elseif ($type_salary == 2){
//            $resumes->minimum_salary = null;
//            $resumes->maximum_salary = null;
//            $resumes->salary = $request->input('salary_fixed') ?? ' ';
//        }else{
//            $resumes->minimum_salary = null;
//            $resumes->maximum_salary = null;
//            $resumes->salary = null;
//        }
//
//        $resumes->resume_content = $request->input('resume_content');
//
//        $networkProfiles = [];
...
//            for ($i = 0; $i < $count; $i++) {
//                $educations[] = [
//                    'school_name' => isset($school_name[$i]) ? $school_name[$i] : '',
//                    'qualification' => isset($qualification[$i]) ? $qualification[$i] : '',
//                    'start_day' => isset($education_start[$i]) ? $education_start[$i] : '',
//                    'end_day' => isset($education_end[$i]) ? $education_end[$i] : '',
//                    'note' => isset($education_note[$i]) ? $education_note[$i] : '',
//                ];
//            }
//
//        }
...
//            for ($i = 0; $i < $count; $i++) {
//                $educations[] = [
//                    'employer_id' => isset($epx_employer[$i]) ? $epx_employer[$i] : '',
//                    'job_title' => isset($job_title[$i]) ? $job_title[$i] : '',
//                    'start_day' => isset($job_start[$i]) ? $job_start[$i] : '',
//                    'end_day' => isset($job_end[$i]) ? $job_end[$i] : '',
//                    'note' => isset($epx_note[$i]) ? $epx_note[$i] : '',
//                ];
//            }
//
//        }
