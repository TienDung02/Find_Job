...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('content_chats', function (Blueprint $table) {
            ...
            $table->string('status_sender')->nullable();
            $table->string('status_receiver')->nullable();
            $table->timestamps();
            $table->softDeletes();
        });
    }
    ...
    {
        Schema::dropIfExists('content_chats');
    }
};
